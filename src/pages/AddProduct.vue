...
<template>
  <div class="min-h-screen px-4 py-10 bg-[#FAFAFA]">
          ...
          <div class="flex items-start">
            <div v-if="previewUrl">
              ...
              <img
                ...
                alt="preview" />
              <!-- <div class="mt-2">
                <button class="text-sm text-red-600" @click="removeImage">
                  Hapus Foto
                </button>
              </div> -->
            </div>
    ...
    <section class="mb-6 border border-[#E9EBE8] rounded-md p-4 bg-white">
      <label class="block mb-1 text-[#5D5C62] text-base font-bold">Harga</label>
    ...
    <section class="mb-6 border border-[#E9EBE8] rounded-md p-4 bg-white">
      ...
      <div class="flex gap-3 mt-3 items-center w-auto">
        <select
          ...
          <option value="" disabled selected hidden>-- Pilih Add On --</option>
          <option
            class="text-[#5D5C62]"
            v-for="a in addons"
            :key="a.id"
      ...
      <div
        ...
        <table class="w-full text-sm border border-[#E9EBE8] px-6 rounded-b-lg">
          ...
          <tbody>
            <tr v-for="(a, idx) in selectedAddons" :key="idx" class="border-t">
              <td class="p-2">
                <div class="flex">
